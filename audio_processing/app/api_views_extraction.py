...
def run_extraction(request):
    ...
    try:  
        ...
        data = {'document_name':document_name, 'document_id':document_id, 'user_id':user_id, "config_id" : config_id, 'organization_id':organization_id, "process_uuid" : process_uuid, "process_type" : "doc" }
